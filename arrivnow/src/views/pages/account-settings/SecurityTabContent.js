...
const SecurityTabContent = () => {
  ...
  const onSubmit = data => {
    if (Object.values(data).every(field => field.length > 0)) {
      axios.post("http://ec2-18-208-170-73.compute-1.amazonaws.com:8081/api/users/change-password", {currentPassword: data.currentPassword, newPassword: data.newPassword})
        .then(response => {
          console.log(response)
          handleClickMsg('Done', 'Your password has been changed. Please login again.', 'success')
