...
import ExportExcel from "@src/views/components/export-excel/roster_excel.js"
...
const CustomHeader = ({ store, toggleSidebar, handlePerPage, rowsPerPage, handleFilter, searchTerm }) => {
  ...
  const [drivernamefilter, setdrivernamefilter] = useState(0)
  const [helpernamefilter, sethelpernamefilter] = useState(0)
...
const searchFilterData = (event) => {
  ...
  dispatch(
    getData({
      starting_point: searchDate,
      start_time: searchTime,
      busno: searchBusNo,
      drivername: searchDriver,
      helpername: searchHelper,
      status: searchStatus,
      page: 1,
      perPage: 10,
      sort: "desc",
  ...
  return (
    <div className='invoice-list-table-header w-100 me-1 ms-50 mt-2 mb-75'>
      <Row className='mb-2'>
        ...
        <Modal isOpen={centeredModal} toggle={() => setCenteredModal(!centeredModal)} className='modal-dialog-centered'>
          ...
          <ModalBody>
            ...
            <div className='form-check form-check-inline'>
              <Input type='checkbox' id='drivername' checked={drivernamefilter} onChange={() => setdrivernamefilter(!drivernamefilter)} />
              <Label for='basic-cb-unchecked' className='form-check-label'>
                Driver Name
              </Label>
            </div><br/>
            <div className='form-check form-check-inline'>
              <Input type='checkbox' id='helpername' checked={helpernamefilter} onChange={() => sethelpernamefilter(!helpernamefilter)} />
              <Label for='basic-cb-unchecked' className='form-check-label'>
               Helper Name
              </Label>
            </div><br/>
      ...
      { showAdvancFilter ? <Row className='mt-1 mb-50'>
            ...
            {helpernamefilter ? <Col lg='3' md='6' className='mb-1'>
              <Label className='form-label' for='pre_route'>
                Helper
              </Label>
              <Input
                ...
                placeholder=''
                value={searchHelper}
                onChange={handleHelperFilter}
              />
            </Col> : null}
            {drivernamefilter ? <Col lg='3' md='6' className='mb-1'>
              <Label className='form-label' for='next_route'>
                DriverName
              </Label>
              <Input id='phone_number' placeholder='' value={searchDriver} onChange={handleDriverFilter}/>
            </Col> : null} 
      ...
      <Row>
        ...
        >
          ...
          <ExportExcel csvData={store.data} fileName='roster_contractor' />
