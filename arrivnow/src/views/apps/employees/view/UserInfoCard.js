...
const UserInfoCard = ({ selectedUser }) => {
  ...
  const handleSuspendedClick = () => {
    return MySwal.fire({
      ...
      confirmButtonText: 'Yes, Rejected employee!',
      customClass: {
  ...
  return (
    <Fragment>
            ...
            <div className='d-flex flex-column'>
              ...
              <div className='d-flex flex-column mb-2'>
                <div className='user-info'>
                  ...
                  {selectedUser !== null ? (
                    <Badge color={roleColors['maintainer']} className='text-capitalize px-3 py-1'>
                      Employee
                    </Badge>
                  ) : null}
                </div>
      ...
      <div className='info-container col-md-12 col-lg-12 col-xl-12 pad_10x'>
          <h4 className='fw-bolder border-bottom pb-50 mb-1'>Employee Info</h4>
            {selectedUser !== null ? (
              <div className='row'>
                ...
                <div className='mb-75 col-4'>
                  ...
                  <div className='usr_ipt_cust'>{selectedUser.attributes.contact}</div>
                </div>
                <div className='mb-75 col-4'>
                ...
                <div className='mb-75 col-4'>
                  <div className='fw-bolder me-25'>Employee ID</div>
                  <div className='usr_ipt_cust'>{selectedUser.attributes.employeeid}</div>
                </div>
                <div className='mb-75 col-4'>
                  <div className='fw-bolder me-25'>Status:</div>
                  <div className='usr_ipt_cust'>
                    <Badge className='text-capitalize' color={statusColors[selectedUser.attributes.is_activated ? 'approved' : 'pending']}>
                      {selectedUser.attributes.is_activated ? 'Approved' : 'Pending'}
                    </Badge>
                  </div>
                </div>
              </div>
